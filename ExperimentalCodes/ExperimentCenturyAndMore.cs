...
{
    public class ExperimentCenturyAndMore
    {
        public static void ExperimentMore()
        {
            int y = 1000;
            int z = 1010;
            int year = 0;
            ...
            Console.Write("input a year in numbers: ");
            int inputYear = Convert.ToInt32(Console.ReadLine()); //user input

            if (inputYear % 100 == 00 || inputYear % 1000 == 000)
            {
                Console.WriteLine(inputYear / 100 + "th Century");
            }
            else
            {
                Console.WriteLine((inputYear / 100 + 1) + "th Century");
            }
        }
    }
}